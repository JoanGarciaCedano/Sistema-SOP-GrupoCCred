	...
	static public function ctrCrearProducto(){
		...
		if(isset($_POST["nuevaDescripcion"])){
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevaDescripcion"]) &&
			   preg_match('/^[a-zA-Z0-9nÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevoCodigoCCR"]) &&
			   preg_match('/^[a-zA-Z0-9nÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevaUnidad"]) &&
			   ...
			   preg_match('/^[0-9.]+$/', $_POST["nuevoPrecioVenta"])){
			    ...
			    $datos = array("id_categoria" => $_POST["nuevaCategoria"],
			    			   ...
			    			   "codigoCCR" => $_POST["nuevoCodigoCCR"],
	...
	static public function ctrEditarProducto(){
		...
		if(isset($_POST["editarDescripcion"])){
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarDescripcion"]) &&
			   preg_match('/^[a-zA-Z0-9nÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarCodigoCCR"]) &&
			   preg_match('/^[a-zA-Z0-9nÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarUnidad"]) &&
			   ...
			   preg_match('/^[0-9.]+$/', $_POST["editarPrecioVenta"])){
				...
				$tabla = "productos";
					 ...
					 $datos = array("id_categoria" => $_POST["editarCategoria"],
			    			   ...
			    			   "codigoCCR" => $_POST["editarCodigoCCR"],
